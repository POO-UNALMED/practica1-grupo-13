 ...
 * Las instancias de la clase Agronomo deben ser asignadas a un Terreno al momento de ser creadas 
 */
public class Agronomo extends Empleado implements Serializable{
	...
	/**
	 * Constructor para crear una instancia Agronomo
	 * Establece a una instancia de Terreno el agronomo encargado
	 * Agrega a la lista agronomos la instancia creada
	 * @param nombre El parametro nombre establece el nombre del Agronomo usando a su padre
	 * @param sueldo El parametro sueldo establece el sueldo del Agronomo usando a su padre
	 * @param cedula El parametro cedula establece la cedula del Agronomo usando a su padre
	 * @param terreno El parametro Terreno establece el Terreno del Agronomo usando a su padre
	 */
	...
	//cierre del constructor
	/**
	 * Metodo que erradica una amenaza, recibe la Amenaza que debe erradicarse y el cultivo que la padece
	 * el metodo verifica que el terreno en el que se encuentra el cultivo tenga un agronomo encargado
	 * crea una instancia de pesticida capaz de erradicar la amenaza en cuestion, y manda a matar la amenaza
	 * @param amenaza El parametro amenaza es la instancia de Amenaza que esta atacando
	 * @param cultivo El parametro Cultivo es la instancia de Cultivo que esta bajo ataque 
	 */
	...
	//cierre del metodo erradicarAmenaza
	/**
	...
	//cierre del metodo mostrarAgronomos
	/**
	 * Metodo renunciar, que genera un numero aleatorio x (entre 0 y 1) que representa 
	 * una probabilidad del 15% de que un empleado pueda renunciar, generea el numero random y
	 * (entre 0 y el size de la lista agronomos) que representa un indice para seleccionar un empleado aleatorio 
	 * que renuncia si x es menor a 0.15 
	 */
	...
	/**
	 * Metodo renunciar que recibe como parametro el indice que corresponde al agronomo que renunciara, luego borra el 
	 * terreno al que esta asociado el agronomoo y lo elimina de la lista agronomos
	 * @param opcionElegida El parametro opcionElegida es el indice en la lista agronomos que corresponde al agronomo 
	 * que quiere renunciar
	 */
	...
	//cierre del metodo getAgronomos
}